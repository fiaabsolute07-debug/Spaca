...
/**
 * The new-service form, shared by the /creator/services/new page and the dialog that opens it over Explore. Saving
 * creates a draft and goes to My services, where the creator adds a product file (digital) and publishes.
 */
