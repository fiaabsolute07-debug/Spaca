 ...
 */
export default async function NewServiceDialog() {
  const actor = await getActor();
  if (!actor || !isCreator(actor)) {
    return <ServiceDialog title="Create a service">
  ...
  return <ServiceDialog title="Create a service" description="Save a draft with its scope, price and one sample. You publish it from My services.">
