...
| W5-C2 | P4 pools: fund-once campaign pool per asset, conservation invariant, concurrent allocations, per-asset release status (cash ok/token retry), unused refund, perk/NFT entitlements, domain-bound release authorization (server side) | CRY-06..10, CRY-12 | W5-C1 | TODO |
| W6+ | P5 discovery backend, P6 PUBLISH/ACCESS/DIGITAL backend | DSC, XPL | W5 | TODO |
